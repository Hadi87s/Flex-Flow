...
const CircularText: React.FC<CircularTextProps> = ({
    ...
    switch (onHover) {
      ...
      case "goBonkers":
        controls.start({
          rotate: currentRotation + 360,
          scale: 0.8,
          transition: getTransition(spinDuration / 10, currentRotation),
        });
        break;
      default:
        break;
  ...
  return (
    <motion.div
      initial={{ rotate: 0 }}
      className={`mx-auto rounded-full w-[70px] h-[70px] text-white text-center cursor-pointer origin-center ${className}`}
      animate={controls}
