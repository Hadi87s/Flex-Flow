    ...
    controls.start(
      {
        background: [
            ...
            "radial-gradient(circle at 10% 20%, rgba(255, 237, 178, 0.15) 0%, rgba(251, 191, 36, 0.2) 50%, transparent 100%)",  // Light amber
            "radial-gradient(circle at 90% 80%, rgba(245, 158, 11, 0.2) 0%, rgba(217, 119, 6, 0.15) 50%, transparent 100%)",      // Medium orange
            "radial-gradient(circle at 50% 50%, rgba(180, 83, 9, 0.15) 0%, rgba(124, 45, 0, 0.2) 50%, transparent 100%)",         // Deep orange
            "radial-gradient(circle at 30% 70%, rgba(255, 215, 161, 0.1) 0%, rgba(252, 211, 77, 0.2) 50%, transparent 100%)",    // Pale orange
            "radial-gradient(circle at 70% 30%, rgba(249, 168, 37, 0.18) 0%, rgba(245, 158, 11, 0.3) 65%, transparent 100%)",    // Vibrant orange
          ],
      },
      {
        duration: 20,
    ...
    <div className="m-3 rounded-3xl relative flex flex-col items-center justify-center h-[96vh] overflow-hidden bg-zinc-900 text-white">
      ...
      >
        ...
        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
          <Link
            href="/login"
            className="px-8 py-3 bg-orange-800 rounded-lg text-lg font-semibold hover:bg-orange-700 transition duration-300"
          >
            Get Started
          </Link>
        </motion.div>
